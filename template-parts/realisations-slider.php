<?php
	...
	$realisations = get_field('realisations','option');
			...
			<div id="slider-1">
				<?php
					foreach( $realisations1 as $real ):
						$image = get_the_post_thumbnail_url( $real['client']->ID, 'realisations-slide' );
						$titre =  $real['client']->post_title;
				?>
		...
		<div id="slider-content-1" class="slider-content">
			<ul>
				<?php
					...
					foreach( $realisations1 as $real ):
						$titre =  $real['client']->post_title;
						$content = $real['client']->post_content;
						$type_de_site = get_terms_liste( $real['client']->ID );
						$services = get_tag_liste( $real['client']->ID );
